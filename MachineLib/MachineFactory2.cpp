 ...
 */
MachineFactory2::MachineFactory2(const std::wstring& resourcesDir, ma_engine* audioEngine) :
...
std::shared_ptr<Machine> MachineFactory2::Create() {
    ...
    background->SetImage(mResourcesDir + L"/images/keyboard.png");
    background->Rectangle(-BackgroundWidth /2, 0, BackgroundWidth, 0);
    background->SetPosition(BackgroundCenter, 150);
